...
const Card = (props) => {
  ...
  return (
    <>
      <div className={`box btn_shadow col-md-3 col-xl-3 m-2 col-lg-3 ${props.color}`}>
        {/* <div className='img'>
          <img src={props.image} alt={props.title} onClick={toggleModal} />
        </div> */}
      ...
      {/* Popup box */}
      {modal && (
        <div className={modal ? "modal modal-blog active-modal" : "modal modal-blog"}>
